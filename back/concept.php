...
<html lang="fr">
  <head>
    ...
    <title>Concept - Back parisian insider</title>
    
  </head>
  <body class=" light-blue lighten-4">
  <?php include('../includes/header_back.php'); ?>
<div class="container">
<h1>Modifier la page concept</h1>
<form class="form-horizontal" method="POST" action="../core/concept.php">
  <fieldset>
   
    
    <div class="form-group">
      <label for="textArea" class="col-lg-2 control-label">Texte concept</label>
      <div class="col-lg-10">
